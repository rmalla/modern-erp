    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge_account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='charges_purchasing', to='accounting.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('doc_status', models.CharField(choices=[('drafted', 'Drafted'), ('in_progress', 'In Progress'), ('waiting_delivery', 'Waiting Delivery'), ('waiting_invoice', 'Waiting Invoice'), ('complete', 'Complete'), ('closed', 'Closed'), ('reversed', 'Reversed'), ('voided', 'Voided')], default='drafted', max_length=20)),
                ...
                ('business_partner', models.ForeignKey(limit_choices_to={'is_vendor': True}, on_delete=django.db.models.deletion.PROTECT, to='core.businesspartner')),
                ...
                ('price_list', models.ForeignKey(limit_choices_to={'is_purchase_price_list': True}, on_delete=django.db.models.deletion.PROTECT, to='inventory.pricelist')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='updated_%(class)s', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('vendor_product_no', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movement_type', models.CharField(choices=[('vendor_receipt', 'Vendor Receipt'), ('vendor_return', 'Vendor Return'), ('customer_return', 'Customer Return'), ('internal_use', 'Internal Use')], default='vendor_receipt', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('document_no', models.CharField(max_length=50, unique=True)),
                ('vendor_invoice_no', models.CharField(blank=True, help_text="Vendor's invoice number", max_length=100)),
                ('description', models.TextField(blank=True)),
                ...
                ('invoice_type', models.CharField(choices=[('standard', 'Standard Invoice'), ('credit_memo', 'Credit Memo'), ('debit_memo', 'Debit Memo'), ('expense_report', 'Expense Report')], default='standard', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='purchasing.charge')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='created_%(class)s', to=settings.AUTH_USER_MODEL)),
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lines', to='purchasing.vendorbill')),
                ('order_line', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='purchasing.purchaseorderline')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='inventory.product')),
                ('tax', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounting.tax')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='updated_%(class)s', to=settings.AUTH_USER_MODEL)),
            ],
